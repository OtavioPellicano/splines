...
double LinearInterpolator::calculate_delta_x_projection(double position, const AdjacentVertices &adjacent_vertices) const
{
...
double LinearInterpolator::calculate_delta_y_projection(double position, const AdjacentVertices &adjacent_vertices) const
{
    auto const& [v_1, v_2] = adjacent_vertices;
    auto delta_s = position - v_1.position();
...
double LinearInterpolator::calculate_delta_z_projection(double position, const AdjacentVertices &adjacent_vertices) const
{
    auto const& [v_1, v_2] = adjacent_vertices;
    auto delta_s = position - v_1.position();
